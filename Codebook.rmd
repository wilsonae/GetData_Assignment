...
## Project Description
This project was carried out as part of the programming assignment for the Getting and Cleaning Data course.  The purpose of the project is to demonstrate the ability to collect, work with, and clean a data set. The goal is to prepare a tidy dataset that can be used for later analysis. 
...
- copy [*run_analysis.R*](https://github.com/wilsonae/GetData_Assignment/blob/master/run_analysis.R) from this repo to your working directory.  Note: **do not** copy it to the *"UCI HAR Dataset"* subfolder underneath your working directory.
...
###Variable 1 (activity)
The activity variable indicates what 'exercise' was being carryied out by the subject when the measurements were being taken.  
The activity variable 
- is a Factor w/ 6 levels
...
- has a unit of measurement dependdent upon the corresponding feature
