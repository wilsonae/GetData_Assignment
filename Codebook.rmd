...
####Notes on variable 3:
Complete details of the meaning of these variable names are given in the [features_info.txt](GetData_Assignment/features_info.txt) file that is in this repo and the "UCI HAR Dataset" folder in your working directory.
