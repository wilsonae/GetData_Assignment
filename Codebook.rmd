...
###Assumptions
It is assumed that
- the raw data data has been downloaded from  https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip
...
- [*run_analysis.R*](GetData_Assignment/run_analysis.R) has been copied from this repo to your working directory.  (Note: **do not** copy it to the *"UCI HAR Dataset"* subfolder underneath your working directory.)
